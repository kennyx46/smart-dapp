...
App is bootstrapped using create-react-app. You can use app for checking your metamask account balance, investing into predefined ICO, viewing your ICO token balance and percentage of collected Wei for ICO.
